...
##Reorder
 ##data$Cruise <- factor(data$Cruise , levels = ##c("WQJAN", "WQFEB", "WQMAR", "WQAPR", "WQMAY", ##"WQJUN", "HYJUN", "WQJUL", "HYJUL", "WQAUG", ##"HYAUG", "WQSEP", "HYSEP", "WQOCT", "WQNOV", ##"WQDEC"))+

ggplot(data = test, aes(x = Cruise, y = AvgTemp))+
...
##Creates a boxplot and assigns a fill color
  ...
  labs(x= "WQJAN", "WQFEB", "WQMAR", "WQAPR", "WQMAY", "WQJUN", "HYJUN", "WQJUL", "HYJUL", "WQAUG", "HYAUG", "WQSEP", "HYSEP", "WQOCT", "WQNOV", "WQDEC", y="Average Temperature (deg C)")+
